        ...
        return {
            getNwauCalculation: function(encounter, journey) {
              ...
              switch (encounter.classification) {
                    ...
                    case 'Emergency Department UDG':
                        return Calculator.EDUDG(adjustments, encounter.edudg.id, journey.nwauVersion, journey);
                    case 'Emergency Department URG':
                        return Calculator.EDURG(adjustments, encounter.edurg.id, journey.nwauVersion, journey);
                    case 'Non Admitted':
            ...
            getCareBounds: function(encounter, journey) {
              ...
              switch (encounter.classification) {
                      ...
                      //console.log(promises);
                        ...
                        return $q.all(promises)
                            .then(function(result) {
                                ...
                                //console.log("acute list");
                                //console.log(acuteList);
                                //console.log("losList");
                                //console.log(losList);
                                //get the DRG
                ...
                case 'MH':
                  promises = [
                    ihpaService.getMH(journey.nwauVersion),
                    ihpaService.getLosState(journey.nwauVersion)
                  ];
                  //console.log("promise");
                  //console.log(promises);
